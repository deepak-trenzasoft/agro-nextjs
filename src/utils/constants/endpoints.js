...
export const GET_CATEGORY_PRODUCT_ENDPOINT = `${process.env.NEXT_PUBLIC_SITE_URL}/api/get-category-product`;

export const CATEGORIES_ENDPOINT = `${process.env.NEXT_PUBLIC_SITE_URL}/api/get-categories`;
